...
// Registration handling (Sign Up)
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    $user_name = $_POST['name'];
    $user_email = $_POST['email'];
    $user_password = password_hash($_POST['password'], PASSWORD_DEFAULT); // Hash the password for security

    $sql = "INSERT INTO user_details (name, email, password) VALUES ('$user_name', '$user_email', '$user_password')";
...
// Login handling (Sign In)
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
    $login_email = $_POST['email'];
    $login_password = $_POST['password'];

    $sql = "SELECT * FROM user_details WHERE email = '$login_email'";
...
<script src="script.js" <meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-eval'">
></script>
</body>
</html>
